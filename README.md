## Craftsman-Agent
<a href="https://www.producthunt.com/products/craftsman-agent/launches/craftsman-agent?embed=true&amp;utm_source=badge-featured&amp;utm_medium=badge&amp;utm_campaign=badge-craftsman-agent" target="_blank" rel="noopener noreferrer"><img alt="Craftsman Agent - Turn any idea into step-by-step 3D building instructions | Product Hunt" width="250" height="54" src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1093139&amp;theme=light&amp;t=1775700784525"></a>
...
<img src="https://static.aiagenta2z.com/scripts/img/comment/80e65ff34838c544f9560047f34a3834.jpg" alt="Craftsman" width="48" height="48" /> Craftsman Agent helps turn your ideas into digital assets and agentic manufacture on demand platform help connect to 1000+ craftsman artists and workshops to make final finished products with just one click.
20+ active Agents and Skills are release: Image Generator, 3D Generator, Toy Generator, Perler Beads Pindou Art Designer,Social Media Posts Designer, Tesla Car Wrap Designer, 3D Printing Designer and more. Craftsman Agent Store help make your customized picture or design to finish products on state-of-art MOD (Manufacturing on Demand) and POD (Print on Demand) Platform

<img src="https://craftsman-agent.aiagenta2z.com/static/website/toy_designer/stuffed_toy/steve_stuff_toy.png" alt="Craftsman-agent 3D Stuffed Toy Generator" width="500" />

| Skills                                                                    | Description                                                                                                                                                                                                                                                                                                                                                                                                           |
|---------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [generate-lego-3D-build-plan](skills/generate-lego-3D-build-plan)          | Generate Lego Build Plans of Lego Bricks, 3D models from text prompt and reference images                                                                                                                                                                                                                                                                                                                             |
| [generate-minecraft-3D-build-plan](skills/generate-minecraft-3D-build-plan)              | Generate Minecraft Build Plans of Minecraft Bricks,Items and Scenes from text prompt and reference images                                                                                                                                                                                                                                                                                                             |
| [generate-tesla-car-wraps](skills/generate-tesla-car-wraps)               | Generate Tesla Car Wrap and Design instruction  from text prompt and reference image, ready to display on Tesla Car Screen                                                                                                                                                                                                                                                                                            |
| [generate-perler-bead-pindou](skills/generate-perler-bead-pindou)         | Generate Perler Beads / Pindou 2D Pixelization Pattern from text prompt and reference images                                                                                                                                                                                                                                                                                                                          |
| [3d-generator](skills/3d-generator/SKILL.md)                              | AI Generated 3D Models using SOTA APIs such as Tripo/Meshy/TripoSR/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Game, Figurine, Stuffed Toy Generation                                                                                                                                                                                                                                        |
| [3d-printing-generator](skills/3d-printing-generator/SKILL.md)            | AI 3D Printing Toy Generator Toy Multi View Sheets and 3D Models Generator using SOTA 3D APIs such as Tripo/Meshy/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Figurine, Stuffed Toy, 3D Printing, Game Asset and Architecture Toy Generation                                                                                                                                                 |
| [ai-poster-generator](skills/ai-poster-generator/SKILL.md)                | AI Image Generator Skills to Generate Multi-Page Image Carousels from Templates such as AI Poster, Social Media Carousel Presentation(Powerpoints), App Store, Icon Designer, Logo Designer,Photo Editor,etc. Sota Models Nano Banana,Imagen-2 and more are available                                                                                                                                                 |
| [ai-ppt-powerpoint-generator](skills/ai-ppt-powerpoint-generator/SKILL.md) | AI PPT PowerPoint Presentation Generator Skills to Generate Multi-Page Image Carousels from Templates of AI PPT PowerPoint, Sota Models Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                                                   |
| [app-store-assets-generator](skills/app-store-assets-generator)           | AI App Store Assets Generator Agent Skills to Generate Multi-Page Image Carousels from Templates of App Store Assets Android and IOS from SOTA models of Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                                  |
| [architecture-generator](skills/architecture-generator)                   | AI Architecture Toy Generator Generate Toy Multi View Sheets and 3D Models Generator using SOTA 3D APIs such as Tripo/Meshy/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Figurine, Stuffed Toy, 3D Printing, Game Asset and Architecture Toy Generation                                                                                                                                       |
| [figurine-generator](skills/figurine-generator)                           | AI Figurine Generator Generated Toy Multi View Sheets and 3D Models Generator using SOTA 3D APIs such as Tripo/Meshy/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Figurine, Stuffed Toy, 3D Printing, Game Asset and Architecture Toy Generation                                                                                                                                              |
| [game-asset-generator](skills/game-asset-generator)                       | AI Game Asset Toy Generator Generate Toy Multi View Sheets and 3D Models Generator using SOTA 3D APIs such as Tripo/Meshy/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Figurine, Stuffed Toy, 3D Printing, Game Asset and Architecture Toy Generation                                                                                                                                         |
| [icon-designer](skills/icon-designer)                                     | AI Icon Designer Skills to Generate Multi-Page Image Carousels from Templates of Icon Designers Sota Models Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                                                                               |
| [image-generator](skills/image-generator)                                 | AI Poster Image Generator Skills to Generate Multi-Page Image Carousels from Templates such as AI Poster Sota Models Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                                                                      |
| [instagram-post-generator](skills/instagram-post-generator)               | AI Instagram Post Generator — Generate editable, Instagram-ready posts and slides with AI-created content, captions, images, text blocks, storylines, and backgrounds. Supports Knowledge Cards, Posters, Movie Introductions, and more, with designs automatically structured according to visual style rules. Powered by Nano Banana, Nano Banana 2, and Imagen 2, with export-ready final posts and slides.        |
| [knowledge-card-generator](skills/knowledge-card-generator)               | AI Knowledge Card Image Generator Skills to Generate Multi-Page Image Carousels from Templates such as Knowledge Card Sota Models Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                                                         |
| [logo-designer](skills/logo-designer)                                     | AI Logo Designer Skills to Generate Multi-Page Image Carousels from Templates of Logo Designers Sota Models Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                                                                               |
| [photo-editor](skills/photo-editor)                                       | AI Photo Editor Skills to Generate Multi-Page Image Carousels from Templates of Photo Editor using Sota Models Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                                                                            |
| [social-media-posts-generator](skills/social-media-posts-generator)       | AI Social Media Posts Generator Skills to Generate Multi-Page Image Carousels from Templates such as AI Social Media Posts of Instagram,Twitter,Xiaohongshu, Sota Models Nano Banana, Nano Banana-2 ,Imagen-2 and more are available                                                                                                                                                                                  |
| [stuffed-toy-generator](skills/stuffed-toy-generator)                     | AI Stuffed Toy Generator Generated Toy Multi View Sheets and 3D Models Generator using SOTA 3D APIs such as Tripo/Meshy/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Figurine, Stuffed Toy, 3D Printing, Game Asset and Architecture Toy Generation                                                                                                                                           |
| [toy-generator](skills/toy-generator)                                     | AI Generated Toy Models using SOTA 3D APIs such as Tripo/Meshy/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Figurine, Stuffed Toy, 3D Printing, Game Asset and Architecture Toy Generation                                                                                                                                                                                                    |
| [x-twitter-post-generator](skills/x-twitter-post-generator)               | AI X Twitter Post Generator — Generate editable, X (Twitter) - ready posts and slides with AI-created content, captions, images, text blocks, storylines, and backgrounds. Supports Knowledge Cards, Posters, Movie Introductions, and more, with designs automatically structured according to visual style rules. Powered by Nano Banana, Nano Banana 2, and Imagen 2, with export-ready final posts and slides.    |
| [xiaohongshu-post-generator](skills/xiaohongshu-post-generator)           | AI Xiaohongshu Post Generator — Generate editable, Xiaohongshu - ready posts and slides with AI-created content, captions, images, text blocks, storylines, and backgrounds. Supports Knowledge Cards, Posters, Movie Introductions, and more, with designs automatically structured according to visual style rules. Powered by Nano Banana, Nano Banana 2, and Imagen 2, with export-ready final posts and slides.  |
...
3D Toy Generator - Multiview Sheets
