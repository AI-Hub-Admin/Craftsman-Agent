---
name: "toy-generator"
description: "AI Generated Toy Models using SOTA 3D APIs such as Tripo/Meshy/etc served on OneKey Agent Gateway by Craftsman Agent, useful for AI Figurine, Stuffed Toy, 3D Printing, Game Asset and Architecture Toy Generation"
env:
...
# AI toy generator designer skills from craftsman-agent
...
| mode              | Generation mode such as `basic`, `standard`, `advanced`, `demo`, Note that demo only return demo results not irrelevant to your inputs. |
...
| Key                  | Description                                                                                                                              |
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| provider_model_id    | Selected 3D generation provider, e.g. tripo/tripo,meshy/meshy,etc.                                                                       |
