#!/usr/bin/env python3
"""Call Craftsman Agent OneKey Router to generate a LEGO build plan."""
...
def main():
    parser = argparse.ArgumentParser(description="Generate LEGO build plan via Craftsman Agent")
